      ...
      >
        ...
        <div>
          ...
          <p className="text-lg mr-20 mb-2">
            ...
            and tools, as well as writing code that's easy to understand and
            maintainable. <span className="whitespace-nowrap">🛠️✨</span>
          </p>
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="text-xl tracking-wider hover:text-blue-400">
                LinkedIn
              </span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="text-xl tracking-wider hover:text-slate-700 dark:hover:text-purple-400">
                GitHub
              </span>
            </Link>
          </div>
      ...
      <section id="projects" className="flex flex-col mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="transition-[border-color,box-shadow] duration-500 border-2 border-slate-200 dark:border-slate-600 shadow-lg dark:shadow-none flex flex-col rounded-lg overflow-clip">
            ...
            <img
              src="https://cdn.dribbble.com/userupload/2970030/file/original-b405f07b44b99610820219e22202c3a4.png?resize=400x0"
              alt=""
              className="w-full h-56 object-cover object-top"
            />
            <div className="flex flex-col p-3">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium">Project title 1</h3>
              ...
              <p className="mb-1">
                ...
                Asperiores illum explicabo, in nihil voluptas repellendus,
                temporibus natus eum quo corporis eius harum repudiandae tenetur
                perspiciatis.
              </p>
              <Link
                href="/"
              ...
              <div className="flex gap-1 text-white text-sm">
                <div className="flex items-center transition-[background-color,color] duration-500 bg-transparent text-red-500 dark:text-white dark:bg-red-600 rounded-lg px-1.5 py-1">
                  <svg
                    viewBox="0 0 128 128"
                ...
                <div className="flex items-center transition-[background-color,color] duration-500 bg-transparent text-pink-500 dark:text-white dark:bg-pink-600 rounded-lg px-1.5 py-1">
                  <span>Sass</span>
                </div>
              </div>
            </div>
