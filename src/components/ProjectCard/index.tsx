...
export const ProjectCard = ({
  ...
  return (
    <div className="transition-[border-color,box-shadow] duration-500 border-2 border-slate-300 dark:border-slate-800 shadow-lg dark:shadow-none flex flex-col rounded-lg overflow-clip">
